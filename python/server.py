...
def check_truth_with_chatgpt(extracted_text):
    ...
    #prompt= 'Please fact-check the following statement based on the data provided:\
    #        **Statement**:' + extracted_text + '\
    #        **Data**:\
    #        1. CarbonBrief (2024):' + carbon_brief_text + '\
    #        **Request**: Based on the data, is the statement true or false? Provide reasoning based on the information from NOAA and IPCC."\
    #        '
